...
public class Product {
    ...
    public com.tonandquangdz.tqmallmobile.Models.Brand getBrand() {
        return Brand;
    }

    public void setBrand(com.tonandquangdz.tqmallmobile.Models.Brand brand) {
        Brand = brand;
    }

    public com.tonandquangdz.tqmallmobile.Models.Category getCategory() {
        return Category;
    }

    public void setCategory(com.tonandquangdz.tqmallmobile.Models.Category category) {
        Category = category;
    }
}
